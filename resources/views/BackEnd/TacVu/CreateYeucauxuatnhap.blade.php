...
@section('title', 'Tạo phiếu yêu cầu xuất nhập')

@section('content-backend')
    <div id="register">
        <p class="h2" style="margin-bottom: 20px;"><img src="{{ asset('upload/icon/Add File_30px.png') }}"> Tạo phiếu yêu cầu xuất nhập kho</p>
            ...
            <div class="">
                  ...
                  <div class="form-row" style=" margin-bottom: 10px;">
                    <div class="col-md-6">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-8">
                              <select class="custom-select {{ $errors->has('loaiphieu') ? ' is-invalid' : '' }}" name="loaiphieu">
                                <option value=""> -- Chọn loại phiếu -- </option>
                                <option value="1"> Phiếu yêu cầu xuất </option>
                                <option value="2"> Phiếu yêu cầu nhập </option>
                              </select>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        <label for="mail_address" class="col-md-4 col-form-label text-md-right">{{ __('Ngày nhận') }}</label>

                        <div class="col-md-7">
                            <input type="date" class="form-control {{ $errors->has('ngaylay') ? ' is-invalid' : '' }}" name="ngaylay" value="{{ old('ngayxuat') }}">
                                ...
                                <tbody class="tbody_xuatkho">
                                  ...
                                  @foreach($vattu as $key => $vt)
                                    <tr>
                                        ...
                                        <td style="vertical-align:middle; text-align: center;">
                                          <input type="number" name="soluong_session" class="form-control soluong_yeucau" id="" data-id="{{$key}}" value="{{ $vt['soluong'] }}">
                                        </td>
                                        <td style="vertical-align:middle; text-align: center;">
                                          <span style="font-weight: bold;" class="amount_nhapxuat">0</span> VNĐ
                                        </td>
                                        <td align="center"  style="vertical-align:middle;">
                                          <button type="button" data-id="{{ $key }}" class="btn btn-primary btn_delete_session_yeucau"><span class="icon ion-ios-trash""></span></button>
                                        </td>
                                    </tr>
                                  @endforeach
                                  @endif
          ...
          <div class="modal-body">
            <nav class="navbar navbar-light bg-light">
                <form class="form-inline">
                    <button class="btn btn-primary my-2" type="button" id="btn-select-vt-yc" data-dismiss="modal" style="margin-left: 10px;">Chọn vật tư</button>
                </form>
            </nav>
