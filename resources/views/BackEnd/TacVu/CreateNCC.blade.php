...
@section('content-backend')
    <div id="register">
        <p class="h2" style="margin-bottom: 20px;"><img src="{{ asset('upload/icon/Businessman_30px.png') }}"> Tạo nhà cung cấp mới</p>
        <form method="POST" action="{{ route('quanlyncc.store') }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="mail_address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ old('address') }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="mail_address" type="text" class="form-control{{ $errors->has('mail_address') ? ' is-invalid' : '' }}" name="mail_address" value="{{ old('mail_address') }}" >
