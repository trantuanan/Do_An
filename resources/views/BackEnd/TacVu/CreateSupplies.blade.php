...
@section('content-backend')
    <div id="register">
        <p class="h2" style="margin-bottom: 20px;"><img src="{{ asset('upload/icon/Businessman_30px.png') }}"> Tạo vật tư mới</p>
        <form method="POST" action="{{ route('quanlyvattu.store') }}">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Tên vật tư" name="name" value="{{ old('name') }}"  >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="mausac" type="text" class="form-control{{ $errors->has('mausac') ? ' is-invalid' : '' }}" placeholder="Màu sắc vật tư" name="mausac" value="{{ old('mausac') }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="thuonghieu" type="text" class="form-control{{ $errors->has('thuonghieu') ? ' is-invalid' : '' }}" placeholder="Thương hiệu" name="thuonghieu" value="{{ old('thuonghieu') }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                      <input type="number" class="form-control {{ $errors->has('dongia') ? ' is-invalid' : '' }}" name="dongia" placeholder="Đơn giá" aria-describedby="inputGroupPrepend" value="0">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="donvi" type="text" class="form-control{{ $errors->has('donvi') ? ' is-invalid' : '' }}" placeholder="Đơn vị" name="donvi" value="{{ old('donvi') }}" >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select class="custom-select {{ $errors->has('loaivt') ? ' is-invalid' : '' }}" name="loaivt">
                      <option value="1">Vật liệu sản xuất</option>
                      <option value="2">Công cụ sản xuất</option>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control{{ $errors->has('ncc_id') ? ' is-invalid' : '' }}" placeholder="Nhà cung cấp" value="{{ old('ncc_id') }}" readonly="true" id="ncc_name">
